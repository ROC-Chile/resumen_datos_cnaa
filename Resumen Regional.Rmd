...
SPs_region_ver <- data_verano %>%
  ...
  select(`Especie`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%  
  arrange(`Especie`) 

SPs_region_ver <- SPs_region_ver %>%
  gt() %>% 
  data_color(
    columns = c(`2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`),
    method = "numeric",
    palette = "Oranges",
...
gtsave(SPs_region_ver, file = "SPs XV CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs XV CNAA oct 2024 inv.png")
...
Sitios_region_ver <- replicas.ver %>%
  ...
  select(`Sitio`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%
...
SPs_region_ver <- data_verano %>%
  ...
  rename(`Especie` = Common.Name) %>%  
  mutate(across(`2010`:`2024`, ~replace_na(.x, 0))) %>%  
  select(`Especie`, `2010`, `2011`, `2012`, `2014`, `2019`, `2024`) %>%  
  arrange(`Especie`) 

SPs_region_ver <- SPs_region_ver %>%
  gt() %>% 
  data_color(
    columns = c(`2010`, `2011`, `2012`, `2014`, `2019`, `2024`),
    method = "numeric",
    palette = "Oranges",
    domain = c(0, max(range(SPs_region_ver %>% select(-Especie), na.rm = TRUE)))
  )
...
Sitios_region_ver <- replicas.ver %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2010`, `2011`, `2012`, `2014`, `2019`, `2024`) %>%
  mutate(Total = rowSums(across(`2010`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
...
gtsave(SPs_region_ver, file = "SPs III CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs III CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs IV CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs IV CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs V CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs V CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs XIII CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs XIII CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs VI CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs VI CNAA oct 2024 inv.png")
...
SPs_region_inv <- data_invierno %>%
  ...
  rename(`Especie` = Common.Name) %>%
  mutate(across(`2009`:`2024`, ~replace_na(.x, 0))) %>%
  select(`Especie`, `2009`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%
  arrange(`Especie`) 

SPs_region_inv <- SPs_region_inv %>%
  gt() %>%
  data_color(
    columns = c(`2009`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`),
    method = "numeric",
    palette = "Blues",
    domain = c(0, max(range(SPs_region_inv %>% select(-Especie), na.rm = TRUE)))
  )
...
gtsave(SPs_region_ver, file = "SPs VII CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs VII CNAA oct 2024 inv.png")
...
Sitios_region_inv <- replicas.inv %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2009`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%
  mutate(Total = rowSums(across(`2009`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
...
gtsave(SPs_region_ver, file = "SPs VIII CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs VIII CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs IX CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs IX CNAA oct 2024 inv.png")
...
gtsave(SPs_region_ver, file = "SPs X CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs X CNAA oct 2024 inv.png")
...
SPs_region_inv <- data_invierno %>%
  ...
  rename(`Especie` = Common.Name) %>%
  mutate(across(`2014`:`2024`, ~replace_na(.x, 0))) %>%
  select(`Especie`, `2014`, `2015`, `2018`, `2019`, `2021`, `2022`, `2023`, `2024`) %>%
  arrange(`Especie`) 

SPs_region_inv <- SPs_region_inv %>%
  gt() %>%
  data_color(
    columns = c(`2014`, `2015`, `2018`, `2019`, `2021`, `2022`, `2023`, `2024`),
    method = "numeric",
    palette = "Blues",
    domain = c(0, max(range(SPs_region_inv %>% select(-Especie), na.rm = TRUE)))
  )
...
SPs_region_ver <- data_verano %>%
  ...
  rename(`Especie` = Common.Name) %>%  
  mutate(across(`2015`:`2024`, ~replace_na(.x, 0))) %>%  
  select(`Especie`, `2015`, `2018`, `2022`, `2023`, `2024`) %>%  
  arrange(`Especie`) 

SPs_region_ver <- SPs_region_ver %>%
  gt() %>% 
  data_color(
    columns = c(`2015`, `2018`, `2022`, `2023`, `2024`),
    method = "numeric",
    palette = "Oranges",
    domain = c(0, max(range(SPs_region_ver %>% select(-Especie), na.rm = TRUE)))
  )
...
Sitios_region_ver <- replicas.ver %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2015`, `2018`, `2022`, `2023`, `2024`) %>%
  mutate(Total = rowSums(across(`2015`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
...
Sitios_region_inv <- replicas.inv %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2014`, `2015`, `2018`, `2019`, `2021`, `2022`, `2023`, `2024`) %>%
  mutate(Total = rowSums(across(`2014`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
...
SPs_region_inv <- data_invierno %>%
  ...
  rename(`Especie` = Common.Name) %>%
  mutate(across(`2009`:`2024`, ~replace_na(.x, 0))) %>%
  select(`Especie`, `2009`, `2010`, `2011`, `2012`, `2014`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%
  arrange(`Especie`) 

SPs_region_inv <- SPs_region_inv %>%
  gt() %>%
  data_color(
    columns = c(`2009`, `2010`, `2011`, `2012`, `2014`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`),
    method = "numeric",
    palette = "Blues",
    domain = c(0, max(range(SPs_region_inv %>% select(-Especie), na.rm = TRUE)))
  )
...
SPs_region_ver <- data_verano %>%
  ...
  rename(`Especie` = Common.Name) %>%  
  mutate(across(`2010`:`2024`, ~replace_na(.x, 0))) %>%  
  select(`Especie`, `2010`, `2011`, `2012`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2023`, `2024`) %>%  
  arrange(`Especie`) 

SPs_region_ver <- SPs_region_ver %>%
  gt() %>% 
  data_color(
    columns = c(`2010`, `2011`, `2012`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2023`, `2024`),
    method = "numeric",
    palette = "Oranges",
    domain = c(0, max(range(SPs_region_ver %>% select(-Especie), na.rm = TRUE)))
  )
...
gtsave(SPs_region_ver, file = "SPs XII CNAA oct 2024 ver.png")
gtsave(SPs_region_inv, file = "SPs XII CNAA oct 2024 inv.png")
...
Sitios_region_ver <- replicas.ver %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2010`, `2011`, `2012`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2023`, `2024`) %>%
  mutate(Total = rowSums(across(`2010`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
...
Sitios_region_inv <- replicas.inv %>%
  pivot_wider(names_from = `year(Date)`, values_from = Visitado, values_fill = "") %>%  
  rename(`Sitio` = Location) %>%  
  select(`Sitio`, `2009`, `2010`, `2011`, `2012`, `2014`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2022`, `2023`, `2024`) %>%
  mutate(Total = rowSums(across(`2009`:`2024`, ~ . != ""))) %>%
  arrange(`Sitio`) %>%  
  gt() %>% 
  data_color(
