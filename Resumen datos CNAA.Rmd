...
```{r}
data <- read.csv("datos cnaa feb 2023.csv")
#incluye .sp
...
sp_all$Censo <- rep(c("Verano", "Invierno"), each = 14)
...
ab_all$Censo <- rep(c("Verano", "Invierno"), each = 14)
...
sitios_all$Censo <- rep(c('Verano','Invierno'), each =14)
...
ggsave("Riqueza CNAA Feb 2023 s.png", sp_plot, width = 4.5, height = 3.5, dpi = 300, type = "cairo")
ggsave("Abundancia CNAA Feb 2023 s.png", ab_plot, width = 4.5, height = 3.5, dpi = 300, type = "cairo")
ggsave("Sitios CNAA Feb 2023 s.png", sitios_plot, width = 4.5, height = 3.5, dpi = 300, type = "cairo")
```
...
gtsave(plot_sitios_region_verano, file = "Sitios Region CNAA Feb 2023 v.png")
gtsave(plot_sp_region_invierno, file = "Riqueza Region CNAA Feb 2023 i.png")
